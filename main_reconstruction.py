...
if __name__ == '__main__':
    ...
    parser.add_argument('--gen_seed', default=100, type=int)
    parser.add_argument('--dataset', default='Gustavosta/Stable-Diffusion-Prompts')
    parser.add_argument('--start', default=0, type=int)
    parser.add_argument('--end', default=1, type=int)
    parser.add_argument('--image_length', default=512, type=int)
    parser.add_argument('--model_id', default='C:\\Users\\18245\\.cache\\huggingface\\hub\\models--stabilityai--stable-diffusion-2-1-base\\snapshots\\5ede9e4bf3e3fd1cb0ef2f7a3fff13ee514fdf06')
    ...
    parser.add_argument('--test_num_inference_steps', default=50, type=int, help="steps of inversion")
    parser.add_argument("--inv_order", type=int, default=1, help="order of inversion, 0:Naive DDIM iversion, 1:Alg1, 2:Alg2")
